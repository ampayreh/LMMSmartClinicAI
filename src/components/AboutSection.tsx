        ...
        <div className="grid gap-12 lg:grid-cols-5 items-start">
          ...
          >
            ...
            <p className="text-base leading-relaxed text-muted-foreground">
              Founded in 2019 in the heart of Budo-Kimbejja, Lynda Michelle Medical Centre began with a simple
              mission: to provide accessible, compassionate healthcare to every family in our community. What
              started as a small clinic has grown into a trusted multi-location healthcare provider across Wakiso District.
            </p>
            <p className="text-base leading-relaxed text-muted-foreground">
              Our dedicated team of licensed clinical officers, midwives, and nurses deliver comprehensive
              care — from prenatal visits and safe deliveries to laboratory diagnostics and immunization.
