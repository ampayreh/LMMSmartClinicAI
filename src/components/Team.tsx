...
const MEMBERS = [
  {
    ...
    bio: "Overseeing clinical operations and delivering quality medical care.",
    initials: "JT",
  ...
  },
  {
    ...
    bio: "Providing compassionate midwifery, antenatal, and safe delivery care.",
    initials: "JN",
  ...
  },
  {
    ...
    bio: "Founded the centre and leads maternal and midwifery services with dedication.",
    initials: "LT",
    size: "w-40 h-40 md:w-56 md:h-56",
    image: lydiaImg,
  },
