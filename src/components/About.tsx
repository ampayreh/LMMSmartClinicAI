...
import clinicImg from "@/assets/clinic-exterior.png";
      ...
      <div className="container max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="rounded-3xl overflow-hidden aspect-[4/5] relative">
            <img src={clinicImg} alt="Lynda Michelle Medical Centre" className="w-full h-full object-cover" loading="lazy" />
          </div>
          <div className="absolute bottom-6 left-6 bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl px-5 py-4">
            <span className="block text-lg font-bold text-amber-accent">Est. 2012</span>
        ...
        >
          ...
          <p className="mt-6 text-text-secondary leading-relaxed">
            Lynda Michelle Medical Centre was established in 2012 to bridge the gap in accessible, quality healthcare for families in Budo-Kimbejja, Nsangi, and the wider Wakiso District. What began as a small outpatient clinic has grown into a trusted community health provider offering eight core services.
          </p>
