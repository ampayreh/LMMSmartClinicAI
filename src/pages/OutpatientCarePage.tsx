      ...
      <section className="py-20 lg:py-24">
        <div className="container mx-auto px-6 max-w-4xl space-y-8">
          {[
            ...
            { title: "Child & Paediatric Care", desc: "Healthcare for infants, children, and adolescents, including illness treatment, growth monitoring, and immunization.", items: ["Paediatric consultations", "Immunization per national schedule", "Growth and nutrition monitoring", "Common childhood illness treatment"] },
          ].map((s, i) => (
